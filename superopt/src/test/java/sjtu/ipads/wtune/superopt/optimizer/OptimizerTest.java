...
public class OptimizerTest {
  ...
  void testLobsters95() {
    ...
    final String[] expected =
        new String[] {
          "SELECT COUNT(DISTINCT `comments`.`id`) FROM `comments` AS `comments` INNER JOIN `stories` AS `stories` ON `stories`.`id` = `comments`.`story_id` INNER JOIN `domains` AS `domains` ON `domains`.`id` = `stories`.`domain_id` WHERE `comments`.`is_deleted` = FALSE AND `comments`.`is_moderated` = FALSE AND `domains`.`domain` = 'lobste.rs' AND MATCH `comments`.`comment` AGAINST ('comment3 comment4' IN BOOLEAN MODE)"
        };
    doTest(appName, stmtId, expected);
  }
  ...
  void testLobsters114() {
    ...
    final String[] expected =
        new String[] {
          "SELECT COUNT(`comments`.`id`) FROM `comments` AS `comments` WHERE `comments`.`is_deleted` = FALSE AND `comments`.`is_moderated` = FALSE AND MATCH `comments`.`comment` AGAINST ('comment1' IN BOOLEAN MODE)"
        };
    doTest(appName, stmtId, expected);
  }
  ...
  void testLobsters129() {
    ...
    final String[] expected =
        new String[] {
          "SELECT COUNT(`stories`.`id`) FROM `stories` AS `stories` WHERE `stories`.`merged_story_id` IS NULL AND `stories`.`is_expired` = FALSE AND (MATCH `stories`.`title` AGAINST ('unique' IN BOOLEAN MODE) OR MATCH `stories`.`description` AGAINST ('unique' IN BOOLEAN MODE) OR MATCH `stories`.`story_cache` AGAINST ('unique' IN BOOLEAN MODE))"
        };
    doTest(appName, stmtId, expected);
  }
  ...
  void testSolidus126() {
    ...
    final String[] expected =
        new String[] {
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_methods`.`id` = `spree_shipping_method_stock_locations`.`shipping_method_id` WHERE `spree_shipping_method_stock_locations`.`shipping_method_id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` WHERE `spree_shipping_methods`.`id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_stock_locations`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` WHERE `spree_shipping_method_zones`.`shipping_method_id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_methods` AS `spree_shipping_methods` INNER JOIN `spree_shipping_method_zones` AS `spree_shipping_method_zones` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_methods`.`id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` WHERE `spree_shipping_method_stock_locations`.`shipping_method_id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_methods` AS `spree_shipping_methods` INNER JOIN `spree_shipping_method_zones` AS `spree_shipping_method_zones` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_methods`.`id` = `spree_shipping_method_stock_locations`.`shipping_method_id` WHERE `spree_shipping_method_zones`.`shipping_method_id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_methods` AS `spree_shipping_methods` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_methods`.`id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_shipping_method_zones` AS `spree_shipping_method_zones` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` WHERE `spree_shipping_method_stock_locations`.`shipping_method_id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_methods` AS `spree_shipping_methods` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_methods`.`id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_shipping_method_zones` AS `spree_shipping_method_zones` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` WHERE `spree_shipping_methods`.`deleted_at` IS NULL AND `spree_shipping_methods`.`id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` WHERE `spree_shipping_method_stock_locations`.`shipping_method_id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          ...
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_methods`.`id` = `spree_shipping_method_stock_locations`.`shipping_method_id` WHERE `spree_shipping_method_zones`.`shipping_method_id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_methods`.`id` = `spree_shipping_method_stock_locations`.`shipping_method_id` WHERE `spree_shipping_methods`.`id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_methods` AS `spree_shipping_methods` INNER JOIN `spree_shipping_method_zones` AS `spree_shipping_method_zones` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_methods`.`id` = `spree_shipping_method_stock_locations`.`shipping_method_id` WHERE `spree_shipping_methods`.`deleted_at` IS NULL AND `spree_shipping_methods`.`id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` WHERE `spree_shipping_methods`.`id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_stock_locations`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` WHERE `spree_shipping_method_stock_locations`.`shipping_method_id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_stock_locations`.`shipping_method_id` = `spree_shipping_methods`.`id` WHERE `spree_shipping_methods`.`deleted_at` IS NULL AND `spree_shipping_methods`.`id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_stock_locations`.`shipping_method_id` = `spree_shipping_methods`.`id` WHERE `spree_shipping_method_stock_locations`.`shipping_method_id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` WHERE `spree_shipping_methods`.`id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_stock_locations`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` WHERE `spree_shipping_methods`.`deleted_at` IS NULL AND `spree_shipping_methods`.`id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` WHERE `spree_shipping_method_zones`.`shipping_method_id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` WHERE `spree_shipping_methods`.`deleted_at` IS NULL AND `spree_shipping_methods`.`id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_stock_locations`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` WHERE `spree_shipping_methods`.`id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_method_stock_locations`.`shipping_method_id` WHERE `spree_shipping_method_zones`.`shipping_method_id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_methods`.`id` = `spree_shipping_method_stock_locations`.`shipping_method_id` WHERE `spree_shipping_methods`.`deleted_at` IS NULL AND `spree_shipping_methods`.`id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_stock_locations`.`shipping_method_id` = `spree_shipping_methods`.`id` WHERE `spree_shipping_method_stock_locations`.`shipping_method_id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_methods` AS `spree_shipping_methods` INNER JOIN `spree_shipping_method_zones` AS `spree_shipping_method_zones` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_methods`.`id` = `spree_shipping_method_stock_locations`.`shipping_method_id` WHERE `spree_shipping_method_stock_locations`.`shipping_method_id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_method_stock_locations`.`shipping_method_id` WHERE `spree_shipping_methods`.`deleted_at` IS NULL AND `spree_shipping_methods`.`id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` WHERE `spree_shipping_method_zones`.`shipping_method_id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_methods`.`id` = `spree_shipping_method_stock_locations`.`shipping_method_id` WHERE `spree_shipping_methods`.`id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` WHERE `spree_shipping_method_stock_locations`.`shipping_method_id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_methods`.`id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` WHERE `spree_shipping_method_stock_locations`.`shipping_method_id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` WHERE `spree_shipping_method_stock_locations`.`shipping_method_id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_stock_locations`.`shipping_method_id` = `spree_shipping_methods`.`id` WHERE `spree_shipping_method_zones`.`shipping_method_id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_method_stock_locations`.`shipping_method_id` WHERE `spree_shipping_method_zones`.`shipping_method_id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_method_stock_locations`.`shipping_method_id` WHERE `spree_shipping_methods`.`id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_methods` AS `spree_shipping_methods` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_methods`.`id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_shipping_method_zones` AS `spree_shipping_method_zones` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` WHERE `spree_shipping_methods`.`id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_method_stock_locations`.`shipping_method_id` WHERE `spree_shipping_method_stock_locations`.`shipping_method_id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_methods` AS `spree_shipping_methods` INNER JOIN `spree_shipping_method_zones` AS `spree_shipping_method_zones` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_methods`.`id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` WHERE `spree_shipping_methods`.`id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_methods` AS `spree_shipping_methods` INNER JOIN `spree_shipping_method_zones` AS `spree_shipping_method_zones` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_methods`.`id` = `spree_shipping_method_stock_locations`.`shipping_method_id` WHERE `spree_shipping_methods`.`id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_stock_locations`.`shipping_method_id` = `spree_shipping_methods`.`id` WHERE `spree_shipping_methods`.`id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` WHERE `spree_shipping_methods`.`deleted_at` IS NULL AND `spree_shipping_methods`.`id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_methods`.`id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` WHERE `spree_shipping_method_zones`.`shipping_method_id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` WHERE `spree_shipping_methods`.`deleted_at` IS NULL AND `spree_shipping_methods`.`id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` WHERE `spree_shipping_methods`.`id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` WHERE `spree_shipping_method_zones`.`shipping_method_id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` WHERE `spree_shipping_method_zones`.`shipping_method_id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_stock_locations`.`shipping_method_id` = `spree_shipping_methods`.`id` WHERE `spree_shipping_methods`.`id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_method_stock_locations`.`shipping_method_id` WHERE `spree_shipping_method_stock_locations`.`shipping_method_id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_methods`.`id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` WHERE `spree_shipping_methods`.`deleted_at` IS NULL AND `spree_shipping_methods`.`id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_method_zones` AS `spree_shipping_method_zones` INNER JOIN `spree_shipping_methods` AS `spree_shipping_methods` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_methods`.`id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` WHERE `spree_shipping_methods`.`id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_methods` AS `spree_shipping_methods` INNER JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_methods`.`id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_shipping_method_zones` AS `spree_shipping_method_zones` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` WHERE `spree_shipping_method_zones`.`shipping_method_id` IN (SELECT `spree_shipping_method0`.`id` AS `id` FROM `spree_shipping_methods` AS `spree_shipping_method0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `spree_shipping_method0`.`id` WHERE `spree_shipping_method0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 874 GROUP BY `spree_shipping_method0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND `spree_shipping_methods`.`deleted_at` IS NULL AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` = 1004) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))",
        };
    doTest(appName, stmtId, expected);
  }
  ...
  void testSolidus551() {
    ...
    final String[] expected =
        new String[] {
          "SELECT DISTINCT `spree_shipping_methods`.`id` AS `id`, `spree_shipping_methods`.`name` AS `name`, `spree_shipping_methods`.`deleted_at` AS `deleted_at`, `spree_shipping_methods`.`created_at` AS `created_at`, `spree_shipping_methods`.`updated_at` AS `updated_at`, `spree_shipping_methods`.`tracking_url` AS `tracking_url`, `spree_shipping_methods`.`admin_name` AS `admin_name`, `spree_shipping_methods`.`tax_category_id` AS `tax_category_id`, `spree_shipping_methods`.`code` AS `code`, `spree_shipping_methods`.`available_to_all` AS `available_to_all`, `spree_shipping_methods`.`carrier` AS `carrier`, `spree_shipping_methods`.`service_level` AS `service_level`, `spree_shipping_methods`.`available_to_users` AS `available_to_users` FROM `spree_shipping_methods` AS `spree_shipping_methods` LEFT JOIN `spree_shipping_method_stock_locations` AS `spree_shipping_method_stock_locations` ON `spree_shipping_methods`.`id` = `spree_shipping_method_stock_locations`.`shipping_method_id` INNER JOIN `spree_shipping_method_zones` AS `spree_shipping_method_zones` ON `spree_shipping_method_zones`.`shipping_method_id` = `spree_shipping_methods`.`id` INNER JOIN `spree_zone_members` AS `spree_zone_members` ON `spree_shipping_method_zones`.`zone_id` = `spree_zone_members`.`zone_id` WHERE `spree_shipping_methods`.`deleted_at` IS NULL AND `spree_shipping_methods`.`id` IN (SELECT `q0`.`id` AS `id` FROM `spree_shipping_methods` AS `q0` INNER JOIN `spree_shipping_method_categories` AS `spree_shipping_method_categories` ON `spree_shipping_method_categories`.`shipping_method_id` = `q0`.`id` WHERE `q0`.`deleted_at` IS NULL AND `spree_shipping_method_categories`.`shipping_category_id` = 544 GROUP BY `q0`.`id` HAVING COUNT(DISTINCT `spree_shipping_method_categories`.`id`) = 1) AND (`spree_shipping_methods`.`available_to_all` = TRUE OR `spree_shipping_method_stock_locations`.`stock_location_id` IS NULL) AND (`spree_zone_members`.`zoneable_type` = 'Spree::State' AND `spree_zone_members`.`zoneable_id` IN (?) OR `spree_zone_members`.`zoneable_type` = 'Spree::Country' AND `spree_zone_members`.`zoneable_id` IN (?))"
        };
    doTest(appName, stmtId, expected);
  }
