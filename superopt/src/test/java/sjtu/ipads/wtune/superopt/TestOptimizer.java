...
public class TestOptimizer {
  ...
  void testDiscourse1178() {
    ...
    final String[] expected =
        new String[] {
          ...
          "SELECT \"posts\".\"id\" AS \"id\", \"posts\".\"post_number\" AS \"post_number\" FROM \"posts\" AS \"posts\" WHERE (\"posts\".\"user_id\" = 915 OR \"posts\".\"post_type\" IN ($1)) AND \"posts\".\"topic_id\" = 15986 AND \"posts\".\"post_type\" = 1 AND NOT \"posts\".\"deleted_at\" IS NULL AND \"posts\".\"post_number\" > 1 AND NOT \"posts\".\"deleted_at\" IS NULL ORDER BY \"posts\".\"post_number\" ASC LIMIT 2",
        };
    doTest(appName, stmtId, expected);
  }
  ...
  void testDiscourse1179() {
    ...
    final String[] expected =
        new String[] {
          ...
          "SELECT \"posts\".\"id\" AS \"id\" FROM \"posts\" AS \"posts\" WHERE \"posts\".\"topic_id\" = 15986 AND \"posts\".\"post_type\" = 1 AND \"posts\".\"post_type\" IN ($1) AND NOT \"posts\".\"deleted_at\" IS NULL AND \"posts\".\"post_number\" > 1 AND NOT \"posts\".\"deleted_at\" IS NULL ORDER BY \"posts\".\"post_number\" ASC LIMIT 99"
        };
    doTest(appName, stmtId, expected);
  }
  ...
  void testDiscourse1182() {
    ...
    final String[] expected =
        new String[] {
          ...
          "SELECT \"posts\".\"id\" AS \"id\" FROM \"posts\" AS \"posts\" WHERE \"posts\".\"topic_id\" = 15986 AND \"posts\".\"score\" >= 99 AND \"posts\".\"post_type\" = 1 AND \"posts\".\"post_type\" IN ($1) AND NOT \"posts\".\"deleted_at\" IS NULL AND \"posts\".\"post_number\" > 1 AND NOT \"posts\".\"deleted_at\" IS NULL ORDER BY \"posts\".\"post_number\" ASC LIMIT 99"
        };
    doTest(appName, stmtId, expected);
  }
  ...
  void testDiscourse1186() {
    ...
    final String[] expected =
        new String[] {
          ...
          "SELECT \"posts\".\"id\" AS \"id\" FROM \"posts\" AS \"posts\" WHERE \"posts\".\"topic_id\" = 15986 AND \"posts\".\"post_type\" = 1 AND \"posts\".\"post_type\" IN ($1) AND \"posts\".\"id\" = 16810 AND NOT \"posts\".\"deleted_at\" IS NULL AND \"posts\".\"post_number\" > 1 AND NOT \"posts\".\"deleted_at\" IS NULL ORDER BY \"posts\".\"post_number\" ASC LIMIT 99"
        };
    doTest(appName, stmtId, expected);
  }
  ...
  void testDiscourse1214() {
    ...
    final String[] expected =
        new String[] {
          ...
          "SELECT \"posts\".\"id\" AS \"id\" FROM \"posts\" AS \"posts\" WHERE (\"posts\".\"user_id\" = 915 OR \"posts\".\"post_type\" IN ($1)) AND \"posts\".\"topic_id\" = 15986 AND \"posts\".\"post_type\" = 1 AND NOT \"posts\".\"deleted_at\" IS NULL AND \"posts\".\"post_number\" > 1 AND NOT \"posts\".\"deleted_at\" IS NULL ORDER BY \"posts\".\"post_number\" ASC LIMIT 5"
        };
    doTest(appName, stmtId, expected);
  }
  ...
  void testDiscourse2783() {
    ...
    final String[] expected =
        new String[] {
          ...
          "SELECT \"topic_allowed_groups\".\"group_id\" AS \"group_id\" FROM \"topic_allowed_groups\" AS \"topic_allowed_groups\" WHERE \"topic_allowed_groups\".\"topic_id\" = 17701 AND \"topic_allowed_groups\".\"group_id\" IN ($1)"
        };
    doTest(appName, stmtId, expected);
  }
  ...
  void testShopizer67() {
    ...
    final String[] expected =
        new String[] {
          "SELECT COUNT(DISTINCT `product0_`.`product_id`) AS `col_0_0_` FROM `product_category` AS `categories2_` INNER JOIN `product` AS `product0_` ON `categories2_`.`product_id` = `product0_`.`product_id` INNER JOIN `product_description` AS `descriptio1_` ON `product0_`.`product_id` = `descriptio1_`.`product_id` WHERE `product0_`.`manufacturer_id` = 1 AND `categories2_`.`category_id` IN (?) AND `product0_`.`merchant_id` = 1 AND `product0_`.`date_available` <= '2019-10-21 21:17:32.7' AND `product0_`.`available` = 1 AND `descriptio1_`.`language_id` = 1",
          "SELECT COUNT(DISTINCT `product0_`.`product_id`) AS `col_0_0_` FROM `product_description` AS `descriptio1_` INNER JOIN `product_category` AS `categories2_` ON `descriptio1_`.`product_id` = `categories2_`.`product_id` INNER JOIN `product` AS `product0_` ON `categories2_`.`product_id` = `product0_`.`product_id` WHERE `product0_`.`manufacturer_id` = 1 AND `categories2_`.`category_id` IN (?) AND `product0_`.`merchant_id` = 1 AND `product0_`.`date_available` <= '2019-10-21 21:17:32.7' AND `product0_`.`available` = 1 AND `descriptio1_`.`language_id` = 1",
          "SELECT COUNT(DISTINCT `product0_`.`product_id`) AS `col_0_0_` FROM `product_description` AS `descriptio1_` INNER JOIN `product` AS `product0_` ON `descriptio1_`.`product_id` = `product0_`.`product_id` INNER JOIN `product_category` AS `categories2_` ON `descriptio1_`.`product_id` = `categories2_`.`product_id` WHERE `product0_`.`manufacturer_id` = 1 AND `categories2_`.`category_id` IN (?) AND `product0_`.`merchant_id` = 1 AND `product0_`.`date_available` <= '2019-10-21 21:17:32.7' AND `product0_`.`available` = 1 AND `descriptio1_`.`language_id` = 1",
          "SELECT COUNT(DISTINCT `product0_`.`product_id`) AS `col_0_0_` FROM `product_description` AS `descriptio1_` INNER JOIN `product_category` AS `categories2_` ON `descriptio1_`.`product_id` = `categories2_`.`product_id` INNER JOIN `product` AS `product0_` ON `descriptio1_`.`product_id` = `product0_`.`product_id` WHERE `product0_`.`manufacturer_id` = 1 AND `categories2_`.`category_id` IN (?) AND `product0_`.`merchant_id` = 1 AND `product0_`.`date_available` <= '2019-10-21 21:17:32.7' AND `product0_`.`available` = 1 AND `descriptio1_`.`language_id` = 1",
          "SELECT COUNT(DISTINCT `product0_`.`product_id`) AS `col_0_0_` FROM `product` AS `product0_` INNER JOIN `product_category` AS `categories2_` ON `product0_`.`product_id` = `categories2_`.`product_id` INNER JOIN `product_description` AS `descriptio1_` ON `categories2_`.`product_id` = `descriptio1_`.`product_id` WHERE `product0_`.`manufacturer_id` = 1 AND `categories2_`.`category_id` IN (?) AND `product0_`.`merchant_id` = 1 AND `product0_`.`date_available` <= '2019-10-21 21:17:32.7' AND `product0_`.`available` = 1 AND `descriptio1_`.`language_id` = 1",
          ...
          "SELECT COUNT(DISTINCT `product0_`.`product_id`) AS `col_0_0_` FROM `product_category` AS `categories2_` INNER JOIN `product` AS `product0_` ON `categories2_`.`product_id` = `product0_`.`product_id` INNER JOIN `product_description` AS `descriptio1_` ON `categories2_`.`product_id` = `descriptio1_`.`product_id` WHERE `product0_`.`manufacturer_id` = 1 AND `categories2_`.`category_id` IN (?) AND `product0_`.`merchant_id` = 1 AND `product0_`.`date_available` <= '2019-10-21 21:17:32.7' AND `product0_`.`available` = 1 AND `descriptio1_`.`language_id` = 1",
          "SELECT COUNT(DISTINCT `product0_`.`product_id`) AS `col_0_0_` FROM `product` AS `product0_` INNER JOIN `product_description` AS `descriptio1_` ON `product0_`.`product_id` = `descriptio1_`.`product_id` INNER JOIN `product_category` AS `categories2_` ON `product0_`.`product_id` = `categories2_`.`product_id` WHERE `product0_`.`manufacturer_id` = 1 AND `categories2_`.`category_id` IN (?) AND `product0_`.`merchant_id` = 1 AND `product0_`.`date_available` <= '2019-10-21 21:17:32.7' AND `product0_`.`available` = 1 AND `descriptio1_`.`language_id` = 1",
          "SELECT COUNT(DISTINCT `product0_`.`product_id`) AS `col_0_0_` FROM `product_description` AS `descriptio1_` INNER JOIN `product` AS `product0_` ON `descriptio1_`.`product_id` = `product0_`.`product_id` INNER JOIN `product_category` AS `categories2_` ON `product0_`.`product_id` = `categories2_`.`product_id` WHERE `product0_`.`manufacturer_id` = 1 AND `categories2_`.`category_id` IN (?) AND `product0_`.`merchant_id` = 1 AND `product0_`.`date_available` <= '2019-10-21 21:17:32.7' AND `product0_`.`available` = 1 AND `descriptio1_`.`language_id` = 1",
          "SELECT COUNT(DISTINCT `product0_`.`product_id`) AS `col_0_0_` FROM `product_category` AS `categories2_` INNER JOIN `product_description` AS `descriptio1_` ON `categories2_`.`product_id` = `descriptio1_`.`product_id` INNER JOIN `product` AS `product0_` ON `descriptio1_`.`product_id` = `product0_`.`product_id` WHERE `product0_`.`manufacturer_id` = 1 AND `categories2_`.`category_id` IN (?) AND `product0_`.`merchant_id` = 1 AND `product0_`.`date_available` <= '2019-10-21 21:17:32.7' AND `product0_`.`available` = 1 AND `descriptio1_`.`language_id` = 1",
          "SELECT COUNT(DISTINCT `product0_`.`product_id`) AS `col_0_0_` FROM `product_category` AS `categories2_` INNER JOIN `product_description` AS `descriptio1_` ON `categories2_`.`product_id` = `descriptio1_`.`product_id` INNER JOIN `product` AS `product0_` ON `categories2_`.`product_id` = `product0_`.`product_id` WHERE `product0_`.`manufacturer_id` = 1 AND `categories2_`.`category_id` IN (?) AND `product0_`.`merchant_id` = 1 AND `product0_`.`date_available` <= '2019-10-21 21:17:32.7' AND `product0_`.`available` = 1 AND `descriptio1_`.`language_id` = 1",
        };
    doTest(appName, stmtId, expected);
  }
  ...
  void testShopizer119() {
    ...
    final String[] expected =
        new String[] {
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product` AS `product2_` ON `productrel0_`.`related_product_id` = `product2_`.`product_id` INNER JOIN `product_description` AS `descriptio3_` ON `productrel0_`.`related_product_id` = `descriptio3_`.`product_id` INNER JOIN `product` AS `product1_` ON `productrel0_`.`product_id` = `product1_`.`product_id` WHERE `product1_`.`product_id` = 2 AND `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product` AS `product1_` ON `productrel0_`.`product_id` = `product1_`.`product_id` INNER JOIN `product_description` AS `descriptio3_` ON `productrel0_`.`related_product_id` = `descriptio3_`.`product_id` INNER JOIN `product` AS `product2_` ON `productrel0_`.`related_product_id` = `product2_`.`product_id` WHERE `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `product1_`.`product_id` = 2 AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product` AS `product2_` ON `productrel0_`.`related_product_id` = `product2_`.`product_id` INNER JOIN `product_description` AS `descriptio3_` ON `product2_`.`product_id` = `descriptio3_`.`product_id` INNER JOIN `product` AS `product1_` ON `productrel0_`.`product_id` = `product1_`.`product_id` WHERE `product1_`.`product_id` = 2 AND `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product` AS `product2_` ON `productrel0_`.`related_product_id` = `product2_`.`product_id` INNER JOIN `product` AS `product1_` ON `productrel0_`.`product_id` = `product1_`.`product_id` INNER JOIN `product_description` AS `descriptio3_` ON `product1_`.`product_id` = `descriptio3_`.`product_id` WHERE `descriptio3_`.`product_id` = 2 AND `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product` AS `product1_` ON `productrel0_`.`product_id` = `product1_`.`product_id` INNER JOIN `product` AS `product2_` ON `productrel0_`.`related_product_id` = `product2_`.`product_id` INNER JOIN `product_description` AS `descriptio3_` ON `product2_`.`product_id` = `descriptio3_`.`product_id` WHERE `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `product1_`.`product_id` = 2 AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product` AS `product2_` ON `productrel0_`.`related_product_id` = `product2_`.`product_id` INNER JOIN `product` AS `product1_` ON `productrel0_`.`product_id` = `product1_`.`product_id` INNER JOIN `product_description` AS `descriptio3_` ON `productrel0_`.`product_id` = `descriptio3_`.`product_id` WHERE `descriptio3_`.`product_id` = 2 AND `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product` AS `product1_` ON `productrel0_`.`product_id` = `product1_`.`product_id` INNER JOIN `product` AS `product2_` ON `productrel0_`.`related_product_id` = `product2_`.`product_id` INNER JOIN `product_description` AS `descriptio3_` ON `productrel0_`.`related_product_id` = `descriptio3_`.`product_id` WHERE `productrel0_`.`product_id` = 2 AND `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product` AS `product2_` ON `productrel0_`.`related_product_id` = `product2_`.`product_id` INNER JOIN `product_description` AS `descriptio3_` ON `productrel0_`.`product_id` = `descriptio3_`.`product_id` INNER JOIN `product` AS `product1_` ON `descriptio3_`.`product_id` = `product1_`.`product_id` WHERE `productrel0_`.`product_id` = 2 AND `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product` AS `product2_` ON `productrel0_`.`related_product_id` = `product2_`.`product_id` INNER JOIN `product` AS `product1_` ON `productrel0_`.`product_id` = `product1_`.`product_id` INNER JOIN `product_description` AS `descriptio3_` ON `product1_`.`product_id` = `descriptio3_`.`product_id` WHERE `product1_`.`product_id` = 2 AND `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product_description` AS `descriptio3_` ON `productrel0_`.`related_product_id` = `descriptio3_`.`product_id` INNER JOIN `product` AS `product2_` ON `descriptio3_`.`product_id` = `product2_`.`product_id` INNER JOIN `product` AS `product1_` ON `productrel0_`.`product_id` = `product1_`.`product_id` WHERE `productrel0_`.`product_id` = 2 AND `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product` AS `product2_` ON `productrel0_`.`related_product_id` = `product2_`.`product_id` INNER JOIN `product_description` AS `descriptio3_` ON `productrel0_`.`product_id` = `descriptio3_`.`product_id` INNER JOIN `product` AS `product1_` ON `descriptio3_`.`product_id` = `product1_`.`product_id` WHERE `descriptio3_`.`product_id` = 2 AND `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product` AS `product1_` ON `productrel0_`.`product_id` = `product1_`.`product_id` INNER JOIN `product_description` AS `descriptio3_` ON `productrel0_`.`related_product_id` = `descriptio3_`.`product_id` INNER JOIN `product` AS `product2_` ON `descriptio3_`.`product_id` = `product2_`.`product_id` WHERE `productrel0_`.`product_id` = 2 AND `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product` AS `product1_` ON `productrel0_`.`product_id` = `product1_`.`product_id` INNER JOIN `product` AS `product2_` ON `productrel0_`.`related_product_id` = `product2_`.`product_id` INNER JOIN `product_description` AS `descriptio3_` ON `product1_`.`product_id` = `descriptio3_`.`product_id` WHERE `productrel0_`.`product_id` = 2 AND `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product` AS `product1_` ON `productrel0_`.`product_id` = `product1_`.`product_id` INNER JOIN `product` AS `product2_` ON `productrel0_`.`related_product_id` = `product2_`.`product_id` INNER JOIN `product_description` AS `descriptio3_` ON `product2_`.`product_id` = `descriptio3_`.`product_id` WHERE `productrel0_`.`product_id` = 2 AND `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product` AS `product2_` ON `productrel0_`.`related_product_id` = `product2_`.`product_id` INNER JOIN `product_description` AS `descriptio3_` ON `productrel0_`.`product_id` = `descriptio3_`.`product_id` INNER JOIN `product` AS `product1_` ON `productrel0_`.`product_id` = `product1_`.`product_id` WHERE `descriptio3_`.`product_id` = 2 AND `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product` AS `product1_` ON `productrel0_`.`product_id` = `product1_`.`product_id` INNER JOIN `product_description` AS `descriptio3_` ON `productrel0_`.`related_product_id` = `descriptio3_`.`product_id` INNER JOIN `product` AS `product2_` ON `productrel0_`.`related_product_id` = `product2_`.`product_id` WHERE `productrel0_`.`product_id` = 2 AND `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product` AS `product2_` ON `productrel0_`.`related_product_id` = `product2_`.`product_id` INNER JOIN `product` AS `product1_` ON `productrel0_`.`product_id` = `product1_`.`product_id` INNER JOIN `product_description` AS `descriptio3_` ON `productrel0_`.`product_id` = `descriptio3_`.`product_id` WHERE `product1_`.`product_id` = 2 AND `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product_description` AS `descriptio3_` ON `productrel0_`.`related_product_id` = `descriptio3_`.`product_id` INNER JOIN `product` AS `product2_` ON `descriptio3_`.`product_id` = `product2_`.`product_id` INNER JOIN `product` AS `product1_` ON `productrel0_`.`product_id` = `product1_`.`product_id` WHERE `product1_`.`product_id` = 2 AND `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product` AS `product2_` ON `productrel0_`.`related_product_id` = `product2_`.`product_id` INNER JOIN `product_description` AS `descriptio3_` ON `productrel0_`.`product_id` = `descriptio3_`.`product_id` INNER JOIN `product` AS `product1_` ON `productrel0_`.`product_id` = `product1_`.`product_id` WHERE `productrel0_`.`product_id` = 2 AND `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product` AS `product2_` ON `productrel0_`.`related_product_id` = `product2_`.`product_id` INNER JOIN `product_description` AS `descriptio3_` ON `product2_`.`product_id` = `descriptio3_`.`product_id` INNER JOIN `product` AS `product1_` ON `productrel0_`.`product_id` = `product1_`.`product_id` WHERE `productrel0_`.`product_id` = 2 AND `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product_description` AS `descriptio3_` ON `productrel0_`.`related_product_id` = `descriptio3_`.`product_id` INNER JOIN `product` AS `product2_` ON `productrel0_`.`related_product_id` = `product2_`.`product_id` INNER JOIN `product` AS `product1_` ON `productrel0_`.`product_id` = `product1_`.`product_id` WHERE `productrel0_`.`product_id` = 2 AND `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product` AS `product1_` ON `productrel0_`.`product_id` = `product1_`.`product_id` INNER JOIN `product` AS `product2_` ON `productrel0_`.`related_product_id` = `product2_`.`product_id` INNER JOIN `product_description` AS `descriptio3_` ON `product1_`.`product_id` = `descriptio3_`.`product_id` WHERE `descriptio3_`.`product_id` = 2 AND `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product` AS `product1_` ON `productrel0_`.`product_id` = `product1_`.`product_id` INNER JOIN `product_description` AS `descriptio3_` ON `productrel0_`.`related_product_id` = `descriptio3_`.`product_id` INNER JOIN `product` AS `product2_` ON `descriptio3_`.`product_id` = `product2_`.`product_id` WHERE `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `product1_`.`product_id` = 2 AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product` AS `product2_` ON `productrel0_`.`related_product_id` = `product2_`.`product_id` INNER JOIN `product_description` AS `descriptio3_` ON `productrel0_`.`product_id` = `descriptio3_`.`product_id` INNER JOIN `product` AS `product1_` ON `productrel0_`.`product_id` = `product1_`.`product_id` WHERE `product1_`.`product_id` = 2 AND `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product` AS `product1_` ON `productrel0_`.`product_id` = `product1_`.`product_id` INNER JOIN `product_description` AS `descriptio3_` ON `productrel0_`.`related_product_id` = `descriptio3_`.`product_id` INNER JOIN `product` AS `product2_` ON `descriptio3_`.`product_id` = `product2_`.`product_id` WHERE `product1_`.`product_id` = 2 AND `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product_description` AS `descriptio3_` ON `productrel0_`.`related_product_id` = `descriptio3_`.`product_id` INNER JOIN `product` AS `product2_` ON `productrel0_`.`related_product_id` = `product2_`.`product_id` INNER JOIN `product` AS `product1_` ON `productrel0_`.`product_id` = `product1_`.`product_id` WHERE `product1_`.`product_id` = 2 AND `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product` AS `product1_` ON `productrel0_`.`product_id` = `product1_`.`product_id` INNER JOIN `product` AS `product2_` ON `productrel0_`.`related_product_id` = `product2_`.`product_id` INNER JOIN `product_description` AS `descriptio3_` ON `product1_`.`product_id` = `descriptio3_`.`product_id` WHERE `product1_`.`product_id` = 2 AND `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product` AS `product1_` ON `productrel0_`.`product_id` = `product1_`.`product_id` INNER JOIN `product` AS `product2_` ON `productrel0_`.`related_product_id` = `product2_`.`product_id` INNER JOIN `product_description` AS `descriptio3_` ON `product2_`.`product_id` = `descriptio3_`.`product_id` WHERE `product1_`.`product_id` = 2 AND `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product` AS `product1_` ON `productrel0_`.`product_id` = `product1_`.`product_id` INNER JOIN `product` AS `product2_` ON `productrel0_`.`related_product_id` = `product2_`.`product_id` INNER JOIN `product_description` AS `descriptio3_` ON `productrel0_`.`related_product_id` = `descriptio3_`.`product_id` WHERE `product1_`.`product_id` = 2 AND `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product` AS `product1_` ON `productrel0_`.`product_id` = `product1_`.`product_id` INNER JOIN `product` AS `product2_` ON `productrel0_`.`related_product_id` = `product2_`.`product_id` INNER JOIN `product_description` AS `descriptio3_` ON `productrel0_`.`related_product_id` = `descriptio3_`.`product_id` WHERE `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `product1_`.`product_id` = 2 AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product` AS `product2_` ON `productrel0_`.`related_product_id` = `product2_`.`product_id` INNER JOIN `product` AS `product1_` ON `productrel0_`.`product_id` = `product1_`.`product_id` INNER JOIN `product_description` AS `descriptio3_` ON `product1_`.`product_id` = `descriptio3_`.`product_id` WHERE `productrel0_`.`product_id` = 2 AND `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product` AS `product2_` ON `productrel0_`.`related_product_id` = `product2_`.`product_id` INNER JOIN `product_description` AS `descriptio3_` ON `productrel0_`.`related_product_id` = `descriptio3_`.`product_id` INNER JOIN `product` AS `product1_` ON `productrel0_`.`product_id` = `product1_`.`product_id` WHERE `productrel0_`.`product_id` = 2 AND `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product` AS `product2_` ON `productrel0_`.`related_product_id` = `product2_`.`product_id` INNER JOIN `product_description` AS `descriptio3_` ON `productrel0_`.`product_id` = `descriptio3_`.`product_id` INNER JOIN `product` AS `product1_` ON `descriptio3_`.`product_id` = `product1_`.`product_id` WHERE `product1_`.`product_id` = 2 AND `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product` AS `product2_` ON `productrel0_`.`related_product_id` = `product2_`.`product_id` INNER JOIN `product` AS `product1_` ON `productrel0_`.`product_id` = `product1_`.`product_id` INNER JOIN `product_description` AS `descriptio3_` ON `productrel0_`.`product_id` = `descriptio3_`.`product_id` WHERE `productrel0_`.`product_id` = 2 AND `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `descriptio3_`.`language_id` = 1",
          "SELECT `productrel0_`.`product_relationship_id` AS `product_1_56_0_`, `product1_`.`product_id` AS `product_1_42_1_`, `product2_`.`product_id` AS `product_1_42_2_`, `descriptio3_`.`description_id` AS `descript1_46_3_`, `productrel0_`.`active` AS `active2_56_0_`, `productrel0_`.`code` AS `code3_56_0_`, `productrel0_`.`product_id` AS `product_4_56_0_`, `productrel0_`.`related_product_id` AS `related_5_56_0_`, `productrel0_`.`merchant_id` AS `merchant6_56_0_`, `product1_`.`date_created` AS `date_cre2_42_1_`, `product1_`.`date_modified` AS `date_mod3_42_1_`, `product1_`.`updt_id` AS `updt_id4_42_1_`, `product1_`.`available` AS `availabl5_42_1_`, `product1_`.`cond` AS `cond6_42_1_`, `product1_`.`date_available` AS `date_ava7_42_1_`, `product1_`.`manufacturer_id` AS `manufac25_42_1_`, `product1_`.`merchant_id` AS `merchan26_42_1_`, `product1_`.`customer_id` AS `custome27_42_1_`, `product1_`.`preorder` AS `preorder8_42_1_`, `product1_`.`product_height` AS `product_9_42_1_`, `product1_`.`product_free` AS `product10_42_1_`, `product1_`.`product_length` AS `product11_42_1_`, `product1_`.`quantity_ordered` AS `quantit12_42_1_`, `product1_`.`review_avg` AS `review_13_42_1_`, `product1_`.`review_count` AS `review_14_42_1_`, `product1_`.`product_ship` AS `product15_42_1_`, `product1_`.`product_virtual` AS `product16_42_1_`, `product1_`.`product_weight` AS `product17_42_1_`, `product1_`.`product_width` AS `product18_42_1_`, `product1_`.`ref_sku` AS `ref_sku19_42_1_`, `product1_`.`rental_duration` AS `rental_20_42_1_`, `product1_`.`rental_period` AS `rental_21_42_1_`, `product1_`.`rental_status` AS `rental_22_42_1_`, `product1_`.`sku` AS `sku23_42_1_`, `product1_`.`sort_order` AS `sort_or24_42_1_`, `product1_`.`tax_class_id` AS `tax_cla28_42_1_`, `product1_`.`product_type_id` AS `product29_42_1_`, `product2_`.`date_created` AS `date_cre2_42_2_`, `product2_`.`date_modified` AS `date_mod3_42_2_`, `product2_`.`updt_id` AS `updt_id4_42_2_`, `product2_`.`available` AS `availabl5_42_2_`, `product2_`.`cond` AS `cond6_42_2_`, `product2_`.`date_available` AS `date_ava7_42_2_`, `product2_`.`manufacturer_id` AS `manufac25_42_2_`, `product2_`.`merchant_id` AS `merchan26_42_2_`, `product2_`.`customer_id` AS `custome27_42_2_`, `product2_`.`preorder` AS `preorder8_42_2_`, `product2_`.`product_height` AS `product_9_42_2_`, `product2_`.`product_free` AS `product10_42_2_`, `product2_`.`product_length` AS `product11_42_2_`, `product2_`.`quantity_ordered` AS `quantit12_42_2_`, `product2_`.`review_avg` AS `review_13_42_2_`, `product2_`.`review_count` AS `review_14_42_2_`, `product2_`.`product_ship` AS `product15_42_2_`, `product2_`.`product_virtual` AS `product16_42_2_`, `product2_`.`product_weight` AS `product17_42_2_`, `product2_`.`product_width` AS `product18_42_2_`, `product2_`.`ref_sku` AS `ref_sku19_42_2_`, `product2_`.`rental_duration` AS `rental_20_42_2_`, `product2_`.`rental_period` AS `rental_21_42_2_`, `product2_`.`rental_status` AS `rental_22_42_2_`, `product2_`.`sku` AS `sku23_42_2_`, `product2_`.`sort_order` AS `sort_or24_42_2_`, `product2_`.`tax_class_id` AS `tax_cla28_42_2_`, `product2_`.`product_type_id` AS `product29_42_2_`, `descriptio3_`.`date_created` AS `date_cre2_46_3_`, `descriptio3_`.`date_modified` AS `date_mod3_46_3_`, `descriptio3_`.`updt_id` AS `updt_id4_46_3_`, `descriptio3_`.`description` AS `descript5_46_3_`, `descriptio3_`.`language_id` AS `languag14_46_3_`, `descriptio3_`.`name` AS `name6_46_3_`, `descriptio3_`.`title` AS `title7_46_3_`, `descriptio3_`.`meta_description` AS `meta_des8_46_3_`, `descriptio3_`.`meta_keywords` AS `meta_key9_46_3_`, `descriptio3_`.`meta_title` AS `meta_ti10_46_3_`, `descriptio3_`.`product_id` AS `product15_46_3_`, `descriptio3_`.`download_lnk` AS `downloa11_46_3_`, `descriptio3_`.`product_highlight` AS `product12_46_3_`, `descriptio3_`.`sef_url` AS `sef_url13_46_3_`, `descriptio3_`.`product_id` AS `product15_46_0__`, `descriptio3_`.`description_id` AS `descript1_46_0__` FROM `product_relationship` AS `productrel0_` INNER JOIN `product` AS `product1_` ON `productrel0_`.`product_id` = `product1_`.`product_id` INNER JOIN `product_description` AS `descriptio3_` ON `productrel0_`.`related_product_id` = `descriptio3_`.`product_id` INNER JOIN `product` AS `product2_` ON `productrel0_`.`related_product_id` = `product2_`.`product_id` WHERE `product1_`.`product_id` = 2 AND `productrel0_`.`merchant_id` = 1 AND `productrel0_`.`code` = 'RELATED_ITEM' AND `descriptio3_`.`language_id` = 1",
        };
    doTest(appName, stmtId, expected);
  }
