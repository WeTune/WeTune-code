...
public class TestOptimizer {
  ...
  void testDiscourse207() {
    ...
    final String expected =
        "SELECT DISTINCT \"posts\".\"id\" AS \"id\", \"posts\".\"sort_order\" AS \"sort_order\" FROM \"posts\" AS \"posts\" LEFT JOIN \"topics\" AS \"topics\" ON \"topics\".\"id\" = \"posts\".\"topic_id\" AND NOT \"topics\".\"deleted_at\" IS NULL WHERE \"posts\".\"id\" = 16384 AND \"posts\".\"topic_id\" = 15601 AND (\"posts\".\"user_id\" = -1 OR \"posts\".\"post_type\" IN ($1)) ORDER BY \"sort_order\"";
    doTest(appName, stmtId, expected);
  }
  ...
  void testDiscourse942() {
    ...
    final String[] expected =
        new String[] {
          "SELECT COUNT(*) FROM \"group_users\" AS \"gu\" WHERE \"gu\".\"group_id\" > 0 AND \"gu\".\"owner\" = TRUE AND \"gu\".\"user_id\" = 779"
        };
    doTest(appName, stmtId, expected);
  }
  ...
  void testDiscourse945() {
    ...
    final String[] expected =
        new String[] {
          "SELECT \"gu\".\"group_id\" AS \"group_id\" FROM \"group_users\" AS \"group_users\" INNER JOIN \"group_users\" AS \"gu\" ON \"group_users\".\"group_id\" = \"gu\".\"group_id\" WHERE \"gu\".\"group_id\" > 0 AND \"gu\".\"user_id\" = 779 AND \"group_users\".\"owner\" = TRUE AND \"group_users\".\"user_id\" = 779"
        };
    doTest(appName, stmtId, expected);
  }
  ...
  void testDiscourse948() {
    ...
    final String[] expected =
        new String[] {
          "SELECT \"groups\".\"id\" AS \"id\" FROM \"group_users\" AS \"group_users\" INNER JOIN \"groups\" AS \"groups\" ON \"group_users\".\"group_id\" = \"groups\".\"id\" WHERE \"groups\".\"automatic\" = TRUE AND \"groups\".\"id\" > 0 AND \"group_users\".\"user_id\" = 779",
        };
    doTest(appName, stmtId, expected);
  }
  ...
  void testDiscourse949() {
    ...
    final String[] expected =
        new String[] {
          "SELECT \"groups\".\"id\" AS \"id\" FROM \"group_users\" AS \"group_users\" INNER JOIN \"groups\" AS \"groups\" ON \"group_users\".\"group_id\" = \"groups\".\"id\" WHERE \"groups\".\"automatic\" = TRUE AND \"groups\".\"id\" > 0 AND \"group_users\".\"owner\" = TRUE AND \"group_users\".\"user_id\" = 779"
        };
    doTest(appName, stmtId, expected);
  }
  ...
  void testDiscourse1173() {
    ...
    final String[] expected =
        new String[] {
          "SELECT DISTINCT \"posts\".\"id\" AS \"id\", \"posts\".\"sort_order\" AS \"sort_order\" FROM \"posts\" AS \"posts\" LEFT JOIN \"topics\" AS \"topics\" ON \"topics\".\"id\" = \"posts\".\"topic_id\" AND NOT \"topics\".\"deleted_at\" IS NULL WHERE \"posts\".\"topic_id\" = 15986 AND (\"posts\".\"user_id\" = 913 OR \"posts\".\"post_type\" IN ($1)) ORDER BY \"sort_order\""
        };
    doTest(appName, stmtId, expected);
  }
  ...
  void testDiscourse1178() {
    ...
    final String[] expected =
        new String[] {
          "SELECT \"posts\".\"id\" AS \"id\", \"posts\".\"post_number\" AS \"post_number\" FROM (SELECT \"posts\".\"id\" AS \"id\", \"posts\".\"user_id\" AS \"user_id\", \"posts\".\"topic_id\" AS \"topic_id\", \"posts\".\"post_number\" AS \"post_number\", \"posts\".\"raw\" AS \"raw\", \"posts\".\"cooked\" AS \"cooked\", \"posts\".\"created_at\" AS \"created_at\", \"posts\".\"updated_at\" AS \"updated_at\", \"posts\".\"reply_to_post_number\" AS \"reply_to_post_number\", \"posts\".\"reply_count\" AS \"reply_count\", \"posts\".\"quote_count\" AS \"quote_count\", \"posts\".\"deleted_at\" AS \"deleted_at\", \"posts\".\"off_topic_count\" AS \"off_topic_count\", \"posts\".\"like_count\" AS \"like_count\", \"posts\".\"incoming_link_count\" AS \"incoming_link_count\", \"posts\".\"bookmark_count\" AS \"bookmark_count\", \"posts\".\"avg_time\" AS \"avg_time\", \"posts\".\"score\" AS \"score\", \"posts\".\"reads\" AS \"reads\", \"posts\".\"post_type\" AS \"post_type\", \"posts\".\"sort_order\" AS \"sort_order\", \"posts\".\"last_editor_id\" AS \"last_editor_id\", \"posts\".\"hidden\" AS \"hidden\", \"posts\".\"hidden_reason_id\" AS \"hidden_reason_id\", \"posts\".\"notify_moderators_count\" AS \"notify_moderators_count\", \"posts\".\"spam_count\" AS \"spam_count\", \"posts\".\"illegal_count\" AS \"illegal_count\", \"posts\".\"inappropriate_count\" AS \"inappropriate_count\", \"posts\".\"last_version_at\" AS \"last_version_at\", \"posts\".\"user_deleted\" AS \"user_deleted\", \"posts\".\"reply_to_user_id\" AS \"reply_to_user_id\", \"posts\".\"percent_rank\" AS \"percent_rank\", \"posts\".\"notify_user_count\" AS \"notify_user_count\", \"posts\".\"like_score\" AS \"like_score\", \"posts\".\"deleted_by_id\" AS \"deleted_by_id\", \"posts\".\"edit_reason\" AS \"edit_reason\", \"posts\".\"word_count\" AS \"word_count\", \"posts\".\"version\" AS \"version\", \"posts\".\"cook_method\" AS \"cook_method\", \"posts\".\"wiki\" AS \"wiki\", \"posts\".\"baked_at\" AS \"baked_at\", \"posts\".\"baked_version\" AS \"baked_version\", \"posts\".\"hidden_at\" AS \"hidden_at\", \"posts\".\"self_edits\" AS \"self_edits\", \"posts\".\"reply_quoted\" AS \"reply_quoted\", \"posts\".\"via_email\" AS \"via_email\", \"posts\".\"raw_email\" AS \"raw_email\", \"posts\".\"public_version\" AS \"public_version\", \"posts\".\"action_code\" AS \"action_code\", \"posts\".\"image_url\" AS \"image_url\", \"posts\".\"locked_by_id\" AS \"locked_by_id\" FROM \"posts\" AS \"posts\" WHERE NOT \"posts\".\"deleted_at\" IS NULL AND \"posts\".\"post_number\" > 1 AND \"posts\".\"post_type\" = 1 AND \"posts\".\"topic_id\" = 15986 AND (\"posts\".\"user_id\" = 915 OR \"posts\".\"post_type\" IN ($1)) ORDER BY \"posts\".\"percent_rank\" ASC, \"posts\".\"sort_order\" ASC LIMIT 2) AS \"posts\" WHERE NOT \"posts\".\"deleted_at\" IS NULL ORDER BY \"posts\".\"post_number\" ASC"
        };
    doTest(appName, stmtId, expected);
  }
  ...
  void testDiscourse1179() {
    ...
    final String[] expected =
        new String[] {
          "SELECT \"posts\".\"id\" AS \"id\" FROM (SELECT \"posts\".\"id\" AS \"id\", \"posts\".\"user_id\" AS \"user_id\", \"posts\".\"topic_id\" AS \"topic_id\", \"posts\".\"post_number\" AS \"post_number\", \"posts\".\"raw\" AS \"raw\", \"posts\".\"cooked\" AS \"cooked\", \"posts\".\"created_at\" AS \"created_at\", \"posts\".\"updated_at\" AS \"updated_at\", \"posts\".\"reply_to_post_number\" AS \"reply_to_post_number\", \"posts\".\"reply_count\" AS \"reply_count\", \"posts\".\"quote_count\" AS \"quote_count\", \"posts\".\"deleted_at\" AS \"deleted_at\", \"posts\".\"off_topic_count\" AS \"off_topic_count\", \"posts\".\"like_count\" AS \"like_count\", \"posts\".\"incoming_link_count\" AS \"incoming_link_count\", \"posts\".\"bookmark_count\" AS \"bookmark_count\", \"posts\".\"avg_time\" AS \"avg_time\", \"posts\".\"score\" AS \"score\", \"posts\".\"reads\" AS \"reads\", \"posts\".\"post_type\" AS \"post_type\", \"posts\".\"sort_order\" AS \"sort_order\", \"posts\".\"last_editor_id\" AS \"last_editor_id\", \"posts\".\"hidden\" AS \"hidden\", \"posts\".\"hidden_reason_id\" AS \"hidden_reason_id\", \"posts\".\"notify_moderators_count\" AS \"notify_moderators_count\", \"posts\".\"spam_count\" AS \"spam_count\", \"posts\".\"illegal_count\" AS \"illegal_count\", \"posts\".\"inappropriate_count\" AS \"inappropriate_count\", \"posts\".\"last_version_at\" AS \"last_version_at\", \"posts\".\"user_deleted\" AS \"user_deleted\", \"posts\".\"reply_to_user_id\" AS \"reply_to_user_id\", \"posts\".\"percent_rank\" AS \"percent_rank\", \"posts\".\"notify_user_count\" AS \"notify_user_count\", \"posts\".\"like_score\" AS \"like_score\", \"posts\".\"deleted_by_id\" AS \"deleted_by_id\", \"posts\".\"edit_reason\" AS \"edit_reason\", \"posts\".\"word_count\" AS \"word_count\", \"posts\".\"version\" AS \"version\", \"posts\".\"cook_method\" AS \"cook_method\", \"posts\".\"wiki\" AS \"wiki\", \"posts\".\"baked_at\" AS \"baked_at\", \"posts\".\"baked_version\" AS \"baked_version\", \"posts\".\"hidden_at\" AS \"hidden_at\", \"posts\".\"self_edits\" AS \"self_edits\", \"posts\".\"reply_quoted\" AS \"reply_quoted\", \"posts\".\"via_email\" AS \"via_email\", \"posts\".\"raw_email\" AS \"raw_email\", \"posts\".\"public_version\" AS \"public_version\", \"posts\".\"action_code\" AS \"action_code\", \"posts\".\"image_url\" AS \"image_url\", \"posts\".\"locked_by_id\" AS \"locked_by_id\" FROM \"posts\" AS \"posts\" WHERE NOT \"posts\".\"deleted_at\" IS NULL AND \"posts\".\"post_number\" > 1 AND \"posts\".\"post_type\" = 1 AND \"posts\".\"post_type\" IN ($1) AND \"posts\".\"topic_id\" = 15986 ORDER BY \"posts\".\"percent_rank\" ASC, \"posts\".\"sort_order\" ASC LIMIT 99) AS \"posts\" WHERE NOT \"posts\".\"deleted_at\" IS NULL ORDER BY \"posts\".\"post_number\" ASC"
        };
    doTest(appName, stmtId, expected);
  }
  ...
  void testDiscourse1182() {
    ...
    final String[] expected =
        new String[] {
          "SELECT \"posts\".\"id\" AS \"id\" FROM (SELECT \"posts\".\"id\" AS \"id\", \"posts\".\"user_id\" AS \"user_id\", \"posts\".\"topic_id\" AS \"topic_id\", \"posts\".\"post_number\" AS \"post_number\", \"posts\".\"raw\" AS \"raw\", \"posts\".\"cooked\" AS \"cooked\", \"posts\".\"created_at\" AS \"created_at\", \"posts\".\"updated_at\" AS \"updated_at\", \"posts\".\"reply_to_post_number\" AS \"reply_to_post_number\", \"posts\".\"reply_count\" AS \"reply_count\", \"posts\".\"quote_count\" AS \"quote_count\", \"posts\".\"deleted_at\" AS \"deleted_at\", \"posts\".\"off_topic_count\" AS \"off_topic_count\", \"posts\".\"like_count\" AS \"like_count\", \"posts\".\"incoming_link_count\" AS \"incoming_link_count\", \"posts\".\"bookmark_count\" AS \"bookmark_count\", \"posts\".\"avg_time\" AS \"avg_time\", \"posts\".\"score\" AS \"score\", \"posts\".\"reads\" AS \"reads\", \"posts\".\"post_type\" AS \"post_type\", \"posts\".\"sort_order\" AS \"sort_order\", \"posts\".\"last_editor_id\" AS \"last_editor_id\", \"posts\".\"hidden\" AS \"hidden\", \"posts\".\"hidden_reason_id\" AS \"hidden_reason_id\", \"posts\".\"notify_moderators_count\" AS \"notify_moderators_count\", \"posts\".\"spam_count\" AS \"spam_count\", \"posts\".\"illegal_count\" AS \"illegal_count\", \"posts\".\"inappropriate_count\" AS \"inappropriate_count\", \"posts\".\"last_version_at\" AS \"last_version_at\", \"posts\".\"user_deleted\" AS \"user_deleted\", \"posts\".\"reply_to_user_id\" AS \"reply_to_user_id\", \"posts\".\"percent_rank\" AS \"percent_rank\", \"posts\".\"notify_user_count\" AS \"notify_user_count\", \"posts\".\"like_score\" AS \"like_score\", \"posts\".\"deleted_by_id\" AS \"deleted_by_id\", \"posts\".\"edit_reason\" AS \"edit_reason\", \"posts\".\"word_count\" AS \"word_count\", \"posts\".\"version\" AS \"version\", \"posts\".\"cook_method\" AS \"cook_method\", \"posts\".\"wiki\" AS \"wiki\", \"posts\".\"baked_at\" AS \"baked_at\", \"posts\".\"baked_version\" AS \"baked_version\", \"posts\".\"hidden_at\" AS \"hidden_at\", \"posts\".\"self_edits\" AS \"self_edits\", \"posts\".\"reply_quoted\" AS \"reply_quoted\", \"posts\".\"via_email\" AS \"via_email\", \"posts\".\"raw_email\" AS \"raw_email\", \"posts\".\"public_version\" AS \"public_version\", \"posts\".\"action_code\" AS \"action_code\", \"posts\".\"image_url\" AS \"image_url\", \"posts\".\"locked_by_id\" AS \"locked_by_id\" FROM \"posts\" AS \"posts\" WHERE NOT \"posts\".\"deleted_at\" IS NULL AND \"posts\".\"post_number\" > 1 AND \"posts\".\"post_type\" = 1 AND \"posts\".\"post_type\" IN ($1) AND \"posts\".\"score\" >= 99 AND \"posts\".\"topic_id\" = 15986 ORDER BY \"posts\".\"percent_rank\" ASC, \"posts\".\"sort_order\" ASC LIMIT 99) AS \"posts\" WHERE NOT \"posts\".\"deleted_at\" IS NULL ORDER BY \"posts\".\"post_number\" ASC"
        };
    doTest(appName, stmtId, expected);
  }
  ...
  void testDiscourse1186() {
    ...
    final String[] expected =
        new String[] {
          "SELECT \"posts\".\"id\" AS \"id\" FROM (SELECT \"posts\".\"id\" AS \"id\", \"posts\".\"user_id\" AS \"user_id\", \"posts\".\"topic_id\" AS \"topic_id\", \"posts\".\"post_number\" AS \"post_number\", \"posts\".\"raw\" AS \"raw\", \"posts\".\"cooked\" AS \"cooked\", \"posts\".\"created_at\" AS \"created_at\", \"posts\".\"updated_at\" AS \"updated_at\", \"posts\".\"reply_to_post_number\" AS \"reply_to_post_number\", \"posts\".\"reply_count\" AS \"reply_count\", \"posts\".\"quote_count\" AS \"quote_count\", \"posts\".\"deleted_at\" AS \"deleted_at\", \"posts\".\"off_topic_count\" AS \"off_topic_count\", \"posts\".\"like_count\" AS \"like_count\", \"posts\".\"incoming_link_count\" AS \"incoming_link_count\", \"posts\".\"bookmark_count\" AS \"bookmark_count\", \"posts\".\"avg_time\" AS \"avg_time\", \"posts\".\"score\" AS \"score\", \"posts\".\"reads\" AS \"reads\", \"posts\".\"post_type\" AS \"post_type\", \"posts\".\"sort_order\" AS \"sort_order\", \"posts\".\"last_editor_id\" AS \"last_editor_id\", \"posts\".\"hidden\" AS \"hidden\", \"posts\".\"hidden_reason_id\" AS \"hidden_reason_id\", \"posts\".\"notify_moderators_count\" AS \"notify_moderators_count\", \"posts\".\"spam_count\" AS \"spam_count\", \"posts\".\"illegal_count\" AS \"illegal_count\", \"posts\".\"inappropriate_count\" AS \"inappropriate_count\", \"posts\".\"last_version_at\" AS \"last_version_at\", \"posts\".\"user_deleted\" AS \"user_deleted\", \"posts\".\"reply_to_user_id\" AS \"reply_to_user_id\", \"posts\".\"percent_rank\" AS \"percent_rank\", \"posts\".\"notify_user_count\" AS \"notify_user_count\", \"posts\".\"like_score\" AS \"like_score\", \"posts\".\"deleted_by_id\" AS \"deleted_by_id\", \"posts\".\"edit_reason\" AS \"edit_reason\", \"posts\".\"word_count\" AS \"word_count\", \"posts\".\"version\" AS \"version\", \"posts\".\"cook_method\" AS \"cook_method\", \"posts\".\"wiki\" AS \"wiki\", \"posts\".\"baked_at\" AS \"baked_at\", \"posts\".\"baked_version\" AS \"baked_version\", \"posts\".\"hidden_at\" AS \"hidden_at\", \"posts\".\"self_edits\" AS \"self_edits\", \"posts\".\"reply_quoted\" AS \"reply_quoted\", \"posts\".\"via_email\" AS \"via_email\", \"posts\".\"raw_email\" AS \"raw_email\", \"posts\".\"public_version\" AS \"public_version\", \"posts\".\"action_code\" AS \"action_code\", \"posts\".\"image_url\" AS \"image_url\", \"posts\".\"locked_by_id\" AS \"locked_by_id\" FROM \"posts\" AS \"posts\" WHERE NOT \"posts\".\"deleted_at\" IS NULL AND \"posts\".\"post_number\" > 1 AND \"posts\".\"id\" = 16810 AND \"posts\".\"post_type\" = 1 AND \"posts\".\"post_type\" IN ($1) AND \"posts\".\"topic_id\" = 15986 ORDER BY \"posts\".\"percent_rank\" ASC, \"posts\".\"sort_order\" ASC LIMIT 99) AS \"posts\" WHERE NOT \"posts\".\"deleted_at\" IS NULL ORDER BY \"posts\".\"post_number\" ASC"
        };
    doTest(appName, stmtId, expected);
  }
  ...
  void testDiscourse1191() {
    ...
    final String[] expected =
        new String[] {
          "SELECT DISTINCT \"posts\".\"id\" AS \"id\", \"posts\".\"sort_order\" AS \"sort_order\" FROM \"posts\" AS \"posts\" LEFT JOIN \"topics\" AS \"topics\" ON \"topics\".\"id\" = \"posts\".\"topic_id\" AND NOT \"topics\".\"deleted_at\" IS NULL WHERE NOT \"posts\".\"deleted_at\" IS NULL AND \"posts\".\"id\" IN ($1) AND \"posts\".\"post_type\" IN ($1) AND \"posts\".\"topic_id\" = 15986 ORDER BY \"sort_order\""
        };
    doTest(appName, stmtId, expected);
  }
  ...
  void testDiscourse1200() {
    ...
    final String[] expected =
        new String[] {
          "SELECT DISTINCT \"posts\".\"id\" AS \"id\", \"posts\".\"sort_order\" AS \"sort_order\" FROM \"posts\" AS \"posts\" LEFT JOIN \"topics\" AS \"topics\" ON \"topics\".\"id\" = \"posts\".\"topic_id\" AND NOT \"topics\".\"deleted_at\" IS NULL WHERE \"posts\".\"id\" IN ($1) AND \"posts\".\"topic_id\" = 15986 AND (\"posts\".\"user_id\" = 912 OR \"posts\".\"post_type\" IN ($1)) ORDER BY \"sort_order\""
        };
    doTest(appName, stmtId, expected);
  }
  ...
  void testDiscourse1213() {
    ...
    final String[] expected =
        new String[] {
          "SELECT DISTINCT \"posts\".\"id\" AS \"id\", \"posts\".\"sort_order\" AS \"sort_order\" FROM \"posts\" AS \"posts\" LEFT JOIN \"topics\" AS \"topics\" ON \"topics\".\"id\" = \"posts\".\"topic_id\" AND NOT \"topics\".\"deleted_at\" IS NULL WHERE NOT \"posts\".\"deleted_at\" IS NULL AND \"posts\".\"id\" = 16887 AND \"posts\".\"topic_id\" = 15986 AND (\"posts\".\"user_id\" = 915 OR \"posts\".\"post_type\" IN ($1)) ORDER BY \"sort_order\""
        };
    doTest(appName, stmtId, expected);
  }
  ...
  void testDiscourse1214() {
    ...
    final String[] expected =
        new String[] {
          "SELECT \"posts\".\"id\" AS \"id\" FROM (SELECT \"posts\".\"id\" AS \"id\", \"posts\".\"user_id\" AS \"user_id\", \"posts\".\"topic_id\" AS \"topic_id\", \"posts\".\"post_number\" AS \"post_number\", \"posts\".\"raw\" AS \"raw\", \"posts\".\"cooked\" AS \"cooked\", \"posts\".\"created_at\" AS \"created_at\", \"posts\".\"updated_at\" AS \"updated_at\", \"posts\".\"reply_to_post_number\" AS \"reply_to_post_number\", \"posts\".\"reply_count\" AS \"reply_count\", \"posts\".\"quote_count\" AS \"quote_count\", \"posts\".\"deleted_at\" AS \"deleted_at\", \"posts\".\"off_topic_count\" AS \"off_topic_count\", \"posts\".\"like_count\" AS \"like_count\", \"posts\".\"incoming_link_count\" AS \"incoming_link_count\", \"posts\".\"bookmark_count\" AS \"bookmark_count\", \"posts\".\"avg_time\" AS \"avg_time\", \"posts\".\"score\" AS \"score\", \"posts\".\"reads\" AS \"reads\", \"posts\".\"post_type\" AS \"post_type\", \"posts\".\"sort_order\" AS \"sort_order\", \"posts\".\"last_editor_id\" AS \"last_editor_id\", \"posts\".\"hidden\" AS \"hidden\", \"posts\".\"hidden_reason_id\" AS \"hidden_reason_id\", \"posts\".\"notify_moderators_count\" AS \"notify_moderators_count\", \"posts\".\"spam_count\" AS \"spam_count\", \"posts\".\"illegal_count\" AS \"illegal_count\", \"posts\".\"inappropriate_count\" AS \"inappropriate_count\", \"posts\".\"last_version_at\" AS \"last_version_at\", \"posts\".\"user_deleted\" AS \"user_deleted\", \"posts\".\"reply_to_user_id\" AS \"reply_to_user_id\", \"posts\".\"percent_rank\" AS \"percent_rank\", \"posts\".\"notify_user_count\" AS \"notify_user_count\", \"posts\".\"like_score\" AS \"like_score\", \"posts\".\"deleted_by_id\" AS \"deleted_by_id\", \"posts\".\"edit_reason\" AS \"edit_reason\", \"posts\".\"word_count\" AS \"word_count\", \"posts\".\"version\" AS \"version\", \"posts\".\"cook_method\" AS \"cook_method\", \"posts\".\"wiki\" AS \"wiki\", \"posts\".\"baked_at\" AS \"baked_at\", \"posts\".\"baked_version\" AS \"baked_version\", \"posts\".\"hidden_at\" AS \"hidden_at\", \"posts\".\"self_edits\" AS \"self_edits\", \"posts\".\"reply_quoted\" AS \"reply_quoted\", \"posts\".\"via_email\" AS \"via_email\", \"posts\".\"raw_email\" AS \"raw_email\", \"posts\".\"public_version\" AS \"public_version\", \"posts\".\"action_code\" AS \"action_code\", \"posts\".\"image_url\" AS \"image_url\", \"posts\".\"locked_by_id\" AS \"locked_by_id\" FROM \"posts\" AS \"posts\" WHERE NOT \"posts\".\"deleted_at\" IS NULL AND \"posts\".\"post_number\" > 1 AND \"posts\".\"post_type\" = 1 AND \"posts\".\"topic_id\" = 15986 AND (\"posts\".\"user_id\" = 915 OR \"posts\".\"post_type\" IN ($1)) ORDER BY \"posts\".\"percent_rank\" ASC, \"posts\".\"sort_order\" ASC LIMIT 5) AS \"posts\" WHERE NOT \"posts\".\"deleted_at\" IS NULL ORDER BY \"posts\".\"post_number\" ASC"
        };
    doTest(appName, stmtId, expected);
  }
  ...
  void testDiscourse2012() {
    ...
    final String[] expected =
        new String[] {
          "SELECT DISTINCT \"posts\".\"id\" AS \"id\", \"posts\".\"sort_order\" AS \"sort_order\" FROM \"posts\" AS \"posts\" LEFT JOIN \"topics\" AS \"topics\" ON \"topics\".\"id\" = \"posts\".\"topic_id\" AND NOT \"topics\".\"deleted_at\" IS NULL WHERE NOT \"posts\".\"deleted_at\" IS NULL AND \"posts\".\"id\" = 17616 AND \"posts\".\"post_type\" IN ($1) AND \"posts\".\"topic_id\" = 16515 ORDER BY \"sort_order\""
        };
    doTest(appName, stmtId, expected);
  }
  ...
  void testDiscourse2019() {
    ...
    final String[] expected =
        new String[] {
          "SELECT DISTINCT \"posts\".\"id\" AS \"id\", \"posts\".\"sort_order\" AS \"sort_order\" FROM \"posts\" AS \"posts\" LEFT JOIN \"topics\" AS \"topics\" ON \"topics\".\"id\" = \"posts\".\"topic_id\" AND NOT \"topics\".\"deleted_at\" IS NULL WHERE NOT \"posts\".\"deleted_at\" IS NULL AND \"posts\".\"post_type\" IN ($1) AND \"posts\".\"topic_id\" = 16521 ORDER BY \"sort_order\""
        };
    doTest(appName, stmtId, expected);
  }
  ...
  void testFatfreecrm176() {
    ...
    final String[] expected =
        new String[] {
          "SELECT 1 AS `one` FROM `taggings` AS `taggings` WHERE `taggings`.`context` = 'tags' AND `taggings`.`taggable_id` = 511 AND `taggings`.`taggable_type` = 'Lead' LIMIT 1",
        };
    doTest(appName, stmtId, expected);
  }
  ...
  void testLobsters95() {
    ...
    final String[] expected =
        new String[] {
          "SELECT COUNT(`comments`.`id`) FROM `comments` AS `comments` INNER JOIN `stories` AS `stories` ON `comments`.`story_id` = `stories`.`id` INNER JOIN `domains` AS `domains` ON `stories`.`domain_id` = `domains`.`id` WHERE MATCH `comments`.`comment` AGAINST ('comment3 comment4' IN BOOLEAN MODE) AND `comments`.`is_deleted` = FALSE AND `comments`.`is_moderated` = FALSE AND `domains`.`domain` = 'lobste.rs'",
        };
    doTest(appName, stmtId, expected);
  }
  ...
  void testLobsters129() {
    ...
    final String[] expected =
        new String[] {
          "SELECT COUNT(`stories`.`id`) FROM `stories` AS `stories` WHERE (MATCH `stories`.`title` AGAINST ('unique' IN BOOLEAN MODE) OR MATCH `stories`.`description` AGAINST ('unique' IN BOOLEAN MODE) OR MATCH `stories`.`story_cache` AGAINST ('unique' IN BOOLEAN MODE)) AND `stories`.`is_expired` = FALSE AND `stories`.`merged_story_id` IS NULL",
        };
    doTest(appName, stmtId, expected);
  }
  ...
  void testShopizer31() {
    ...
    final String[] expected =
        new String[] {
          "SELECT `category0_`.`category_id` AS `category1_0_0_`, `descriptio1_`.`description_id` AS `descript1_1_1_`, `language2_`.`language_id` AS `language1_21_2_`, `merchantst3_`.`merchant_id` AS `merchant1_27_3_`, `category0_`.`date_created` AS `date_cre2_0_0_`, `category0_`.`date_modified` AS `date_mod3_0_0_`, `category0_`.`updt_id` AS `updt_id4_0_0_`, `category0_`.`category_image` AS `category5_0_0_`, `category0_`.`category_status` AS `category6_0_0_`, `category0_`.`code` AS `code7_0_0_`, `category0_`.`depth` AS `depth8_0_0_`, `category0_`.`featured` AS `featured9_0_0_`, `category0_`.`lineage` AS `lineage10_0_0_`, `category0_`.`merchant_id` AS `merchan13_0_0_`, `category0_`.`parent_id` AS `parent_14_0_0_`, `category0_`.`sort_order` AS `sort_or11_0_0_`, `category0_`.`visible` AS `visible12_0_0_`, `descriptio1_`.`date_created` AS `date_cre2_1_1_`, `descriptio1_`.`date_modified` AS `date_mod3_1_1_`, `descriptio1_`.`updt_id` AS `updt_id4_1_1_`, `descriptio1_`.`description` AS `descript5_1_1_`, `descriptio1_`.`language_id` AS `languag13_1_1_`, `descriptio1_`.`name` AS `name6_1_1_`, `descriptio1_`.`title` AS `title7_1_1_`, `descriptio1_`.`category_id` AS `categor14_1_1_`, `descriptio1_`.`category_highlight` AS `category8_1_1_`, `descriptio1_`.`meta_description` AS `meta_des9_1_1_`, `descriptio1_`.`meta_keywords` AS `meta_ke10_1_1_`, `descriptio1_`.`meta_title` AS `meta_ti11_1_1_`, `descriptio1_`.`sef_url` AS `sef_url12_1_1_`, `descriptio1_`.`category_id` AS `categor14_1_0__`, `descriptio1_`.`description_id` AS `descript1_1_0__`, `language2_`.`date_created` AS `date_cre2_21_2_`, `language2_`.`date_modified` AS `date_mod3_21_2_`, `language2_`.`updt_id` AS `updt_id4_21_2_`, `language2_`.`code` AS `code5_21_2_`, `language2_`.`sort_order` AS `sort_ord6_21_2_`, `merchantst3_`.`date_created` AS `date_cre2_27_3_`, `merchantst3_`.`date_modified` AS `date_mod3_27_3_`, `merchantst3_`.`updt_id` AS `updt_id4_27_3_`, `merchantst3_`.`store_code` AS `store_co5_27_3_`, `merchantst3_`.`continueshoppingurl` AS `continue6_27_3_`, `merchantst3_`.`country_id` AS `country23_27_3_`, `merchantst3_`.`currency_id` AS `currenc24_27_3_`, `merchantst3_`.`currency_format_national` AS `currency7_27_3_`, `merchantst3_`.`language_id` AS `languag25_27_3_`, `merchantst3_`.`domain_name` AS `domain_n8_27_3_`, `merchantst3_`.`in_business_since` AS `in_busin9_27_3_`, `merchantst3_`.`invoice_template` AS `invoice10_27_3_`, `merchantst3_`.`seizeunitcode` AS `seizeun11_27_3_`, `merchantst3_`.`store_email` AS `store_e12_27_3_`, `merchantst3_`.`store_logo` AS `store_l13_27_3_`, `merchantst3_`.`store_template` AS `store_t14_27_3_`, `merchantst3_`.`store_address` AS `store_a15_27_3_`, `merchantst3_`.`store_city` AS `store_c16_27_3_`, `merchantst3_`.`store_name` AS `store_n17_27_3_`, `merchantst3_`.`store_phone` AS `store_p18_27_3_`, `merchantst3_`.`store_postal_code` AS `store_p19_27_3_`, `merchantst3_`.`store_state_prov` AS `store_s20_27_3_`, `merchantst3_`.`use_cache` AS `use_cac21_27_3_`, `merchantst3_`.`weightunitcode` AS `weightu22_27_3_`, `merchantst3_`.`zone_id` AS `zone_id26_27_3_` FROM `category` AS `category0_` INNER JOIN `merchant_store` AS `merchantst3_` ON `category0_`.`merchant_id` = `merchantst3_`.`merchant_id` INNER JOIN `category_description` AS `descriptio1_` ON `category0_`.`category_id` = `descriptio1_`.`category_id` INNER JOIN `language` AS `language2_` ON `descriptio1_`.`language_id` = `language2_`.`language_id` WHERE `descriptio1_`.`language_id` = 1 AND `merchantst3_`.`merchant_id` = 1 ORDER BY `category0_`.`lineage`, `category0_`.`sort_order` ASC"
        };
    doTest(appName, stmtId, expected);
  }
  ...
  void testShopizer40() {
    ...
    final String[] expected =
        new String[] {
          "SELECT `category0_`.`category_id` AS `category1_0_0_`, `descriptio1_`.`description_id` AS `descript1_1_1_`, `language2_`.`language_id` AS `language1_21_2_`, `merchantst3_`.`merchant_id` AS `merchant1_27_3_`, `category0_`.`date_created` AS `date_cre2_0_0_`, `category0_`.`date_modified` AS `date_mod3_0_0_`, `category0_`.`updt_id` AS `updt_id4_0_0_`, `category0_`.`category_image` AS `category5_0_0_`, `category0_`.`category_status` AS `category6_0_0_`, `category0_`.`code` AS `code7_0_0_`, `category0_`.`depth` AS `depth8_0_0_`, `category0_`.`featured` AS `featured9_0_0_`, `category0_`.`lineage` AS `lineage10_0_0_`, `category0_`.`merchant_id` AS `merchan13_0_0_`, `category0_`.`parent_id` AS `parent_14_0_0_`, `category0_`.`sort_order` AS `sort_or11_0_0_`, `category0_`.`visible` AS `visible12_0_0_`, `descriptio1_`.`date_created` AS `date_cre2_1_1_`, `descriptio1_`.`date_modified` AS `date_mod3_1_1_`, `descriptio1_`.`updt_id` AS `updt_id4_1_1_`, `descriptio1_`.`description` AS `descript5_1_1_`, `descriptio1_`.`language_id` AS `languag13_1_1_`, `descriptio1_`.`name` AS `name6_1_1_`, `descriptio1_`.`title` AS `title7_1_1_`, `descriptio1_`.`category_id` AS `categor14_1_1_`, `descriptio1_`.`category_highlight` AS `category8_1_1_`, `descriptio1_`.`meta_description` AS `meta_des9_1_1_`, `descriptio1_`.`meta_keywords` AS `meta_ke10_1_1_`, `descriptio1_`.`meta_title` AS `meta_ti11_1_1_`, `descriptio1_`.`sef_url` AS `sef_url12_1_1_`, `descriptio1_`.`category_id` AS `categor14_1_0__`, `descriptio1_`.`description_id` AS `descript1_1_0__`, `language2_`.`date_created` AS `date_cre2_21_2_`, `language2_`.`date_modified` AS `date_mod3_21_2_`, `language2_`.`updt_id` AS `updt_id4_21_2_`, `language2_`.`code` AS `code5_21_2_`, `language2_`.`sort_order` AS `sort_ord6_21_2_`, `merchantst3_`.`date_created` AS `date_cre2_27_3_`, `merchantst3_`.`date_modified` AS `date_mod3_27_3_`, `merchantst3_`.`updt_id` AS `updt_id4_27_3_`, `merchantst3_`.`store_code` AS `store_co5_27_3_`, `merchantst3_`.`continueshoppingurl` AS `continue6_27_3_`, `merchantst3_`.`country_id` AS `country23_27_3_`, `merchantst3_`.`currency_id` AS `currenc24_27_3_`, `merchantst3_`.`currency_format_national` AS `currency7_27_3_`, `merchantst3_`.`language_id` AS `languag25_27_3_`, `merchantst3_`.`domain_name` AS `domain_n8_27_3_`, `merchantst3_`.`in_business_since` AS `in_busin9_27_3_`, `merchantst3_`.`invoice_template` AS `invoice10_27_3_`, `merchantst3_`.`seizeunitcode` AS `seizeun11_27_3_`, `merchantst3_`.`store_email` AS `store_e12_27_3_`, `merchantst3_`.`store_logo` AS `store_l13_27_3_`, `merchantst3_`.`store_template` AS `store_t14_27_3_`, `merchantst3_`.`store_address` AS `store_a15_27_3_`, `merchantst3_`.`store_city` AS `store_c16_27_3_`, `merchantst3_`.`store_name` AS `store_n17_27_3_`, `merchantst3_`.`store_phone` AS `store_p18_27_3_`, `merchantst3_`.`store_postal_code` AS `store_p19_27_3_`, `merchantst3_`.`store_state_prov` AS `store_s20_27_3_`, `merchantst3_`.`use_cache` AS `use_cac21_27_3_`, `merchantst3_`.`weightunitcode` AS `weightu22_27_3_`, `merchantst3_`.`zone_id` AS `zone_id26_27_3_` FROM `category` AS `category0_` INNER JOIN `merchant_store` AS `merchantst3_` ON `category0_`.`merchant_id` = `merchantst3_`.`merchant_id` LEFT JOIN `category_description` AS `descriptio1_` ON `category0_`.`category_id` = `descriptio1_`.`category_id` INNER JOIN `language` AS `language2_` ON `descriptio1_`.`language_id` = `language2_`.`language_id` WHERE `merchantst3_`.`store_code` = 'DEFAULT' AND `category0_`.`lineage` LIKE '%/2/%' ORDER BY `category0_`.`lineage`, `category0_`.`sort_order` ASC"
        };
    doTest(appName, stmtId, expected);
  }
  ...
  void testShopizer67() {
    ...
    final String[] expected =
        new String[] {
          "SELECT COUNT(DISTINCT `product0_`.`product_id`) AS `col_0_0_` FROM `product` AS `product0_` INNER JOIN `product_category` AS `categories2_` ON `product0_`.`product_id` = `categories2_`.`product_id` INNER JOIN `product_description` AS `descriptio1_` ON `product0_`.`product_id` = `descriptio1_`.`product_id` WHERE `categories2_`.`category_id` IN (?) AND `descriptio1_`.`language_id` = 1 AND `product0_`.`manufacturer_id` = 1 AND `product0_`.`available` = 1 AND `product0_`.`date_available` <= '2019-10-21 21:17:32.7' AND `product0_`.`merchant_id` = 1",
        };
    doTest(appName, stmtId, expected);
  }
