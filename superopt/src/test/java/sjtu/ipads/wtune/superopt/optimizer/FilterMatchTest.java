...
public class FilterMatchTest {
  ...
  @Test
  void test0() {
    final PlanContext plan = parsePlan("Select a.i From a Where a.i = 1 And a.j < 10 And a.k > 20");
    final Substitution rule = // A fake rule
        Substitution.parse(
  ...
  void test3() {
    final PlanContext plan =
        parsePlan("Select a.i From a Where a.i = 1 And a.k < 10 And a.i In (Select b.x From b)");
    final Substitution rule = //  A fake rule
