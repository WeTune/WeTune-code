...
我们提供了一个已经安装好本实验所需环境与代码仓库的Docker容器，代码的运行与测试均在该容器中进行。
...
1. 实验完成后，在 wetune/lab 目录下， 运行 > bash zip.sh会在/wetune目录下生成一个压缩包，命名为你的学号。你可以在容器外通过`docker cp lab:/wetune/{你的学号}.zip <host_path>`，将压缩包拷贝到主机的指定目录，并手动上传至 [https://ipads.se.sjtu.edu.cn:1313/u/d/1dffd72278c249068100/](https://ipads.se.sjtu.edu.cn:1313/u/d/1dffd72278c249068100/)。