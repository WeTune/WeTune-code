...
import static sjtu.ipads.wtune.sql.ast.NodeFields.NAME_2_1;
import static sjtu.ipads.wtune.sql.ast.constants.Category.INTERVAL;
import static sjtu.ipads.wtune.sql.ast.constants.ExprKind.*;
import static sjtu.ipads.wtune.sql.ast.constants.NodeType.EXPR;
import static sjtu.ipads.wtune.sql.ast.constants.UnaryOp.NOT;
import static sjtu.ipads.wtune.sql.ast.constants.UnaryOp.UNARY_MINUS;
import static sjtu.ipads.wtune.sql.relational.Attribute.ATTRIBUTE;
import static sjtu.ipads.wtune.sql.util.ASTHelper.locateOtherSide;
