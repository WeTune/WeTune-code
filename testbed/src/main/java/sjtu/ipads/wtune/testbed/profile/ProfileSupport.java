...
import static sjtu.ipads.wtune.sql.ast.constants.LiteralKind.NOT_NULL;
...
import static sjtu.ipads.wtune.sql.support.resolution.ParamModifier.Type.CHECK_NULL_NOT;
import static sjtu.ipads.wtune.sql.support.resolution.Params.PARAMS;
import static sjtu.ipads.wtune.sql.support.resolution.ResolutionSupport.isElementParam;
