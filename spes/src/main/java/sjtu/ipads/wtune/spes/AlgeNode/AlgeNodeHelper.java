...
public class AlgeNodeHelper {
  ...
  static Map<Integer, Integer> constructListQPSR(
      List<AlgeNode> inputs1, List<AlgeNode> inputs2, boolean isEq) {
  ...
  private static boolean checkSimpleMatch(
      List<AlgeNode> inputs1, List<AlgeNode> inputs2, Map<Integer, Integer> result, boolean isEq) {
  ...
  private static boolean checkInputMatch(
      List<AlgeNode> inputs1,
      int index,
      List<AlgeNode> inputs2,
      Set<Integer> used,
      Map<Integer, Integer> inputMatches,
      boolean isEq) {
