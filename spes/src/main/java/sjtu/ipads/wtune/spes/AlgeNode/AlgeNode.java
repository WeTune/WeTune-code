...
public abstract class AlgeNode {
  ...
  protected void setBasicFields(
      ...
      List<AlgeNode> inputs,
      List<RexNode> outputExpr,
      Set<RexNode> conditions) {
  ...
  public boolean checkSymbolicOutput(AlgeNode node) {
    ...
    boolean result =
        z3Utility.symbolicOutputEqual(
            buildOutputEnv(node), symbolicOutputs1, symbolicOutputs2, z3Context);
    return result;
  }
  ...
  public boolean checkSymbolicOutput(AlgeNode node, Map<Integer, Integer> columnPairs) {
    ...
    return z3Utility.symbolicOutputEqual(
        buildOutputEnv(node), symbolicTuple1, symbolicTuple2, z3Context);
  }
  ...
  public abstract boolean constructQPSR(AlgeNode node);
  ...
  public abstract AlgeNode clone();
}
