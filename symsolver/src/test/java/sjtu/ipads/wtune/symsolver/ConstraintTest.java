...
public class ConstraintTest {
  ...
  void test() {
    ...
    final Constraint tblEq0 = DecidableConstraint.tableEq(tbls[1], tbls[0]),
        tblEq1 = DecidableConstraint.tableEq(tbls[2], tbls[0]);
    final Constraint pickEq0 = DecidableConstraint.pickEq(picks[1], picks[0]),
        pickEq1 = DecidableConstraint.pickEq(picks[2], picks[0]);
    final Constraint pickFrom0 = DecidableConstraint.pickFrom(picks[0], tbls[0]),
        pickFrom1 = DecidableConstraint.pickFrom(picks[1], tbls[1]);
    final Constraint ref0 = DecidableConstraint.reference(tbls[0], picks[0], tbls[1], picks[1]),
